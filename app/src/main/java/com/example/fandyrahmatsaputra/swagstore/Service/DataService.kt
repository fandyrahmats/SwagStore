package com.example.fandyrahmatsaputra.swagstore.Service
...
object DataService {
    ...
    val hoodies = listOf(
            ...
            Product("Devslopes Gray Hoodie","$29","hoodie03"),
            Product("Devslopes Hoodie Red","$25","hoodie04")
    ...
    val shirts = listOf(
            ...
            Product("Devslopes Logo Shirt Red","$29","shirt03"),
